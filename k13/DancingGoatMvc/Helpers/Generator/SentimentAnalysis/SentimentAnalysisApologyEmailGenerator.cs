...
namespace DancingGoat.Helpers.Generator
{
    ...
    {
        internal static readonly Guid ISSUE_GUID = Guid.Parse("656a4016-04af-480f-adc1-2969fc2f878e");
        internal const string NEWSLETTER_NAME = "DancingGoatMvc.MarketingAutomationEngagement";
        private const string TEMPLATE_NAME = "MvcDemoGeneralEmail";
