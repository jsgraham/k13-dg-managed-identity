...
{
    [TestFixture]
    public class CheckoutServiceTests : ContainerNotBuiltUnitTests
    {
        ...
        public void SetUp()
        {
            ...
            shoppingService.GetCurrentShoppingCart().Returns(shoppingCartInfo);
            ...
            Fake<PaymentOptionInfo, PaymentOptionInfoProvider>(new LocalPaymentOptionInfoProvider());
        ...
        {
            shoppingCartInfo.CouponCodes.Merge(new []
            {
